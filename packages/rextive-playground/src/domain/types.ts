...
export const AVAILABLE_GAMES: GameConfig[] = [
  // === STARTER GAMES (Unlocked from start) ===
  { id: "typing-adventure", name: "Typing Adventure", icon: "keyboard", xpRequired: 0, implemented: true },
  { id: "math-quest", name: "Math Quest", icon: "math", xpRequired: 0, implemented: true },
  // === UNLOCKABLE GAMES (Earn XP to unlock) ===
