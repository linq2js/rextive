...
function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-50 via-white to-sage-50 dark:from-warm-900 dark:via-warm-950 dark:to-warm-900 py-16 sm:py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
              <span className="block text-warm-900 dark:text-warm-100">Discover</span>
              <span className="block text-gradient mt-1">Curated Excellence</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-warm-600 dark:text-warm-400 max-w-2xl mx-auto">
        ...
        {/* Decorative elements */}
        <div className="absolute top-10 left-10 w-72 h-72 bg-brand-200 dark:bg-brand-900 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 animate-pulse-soft" />
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-sage-200 dark:bg-sage-900 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 animate-pulse-soft" style={{ animationDelay: '1s' }} />
      </section>
      ...
      <section id="products" className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-warm-900 dark:text-warm-100">
              Featured Products
            </h2>
            <p className="mt-4 text-warm-600 dark:text-warm-400 max-w-xl mx-auto">
