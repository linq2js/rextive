...
describe("dev utilities", () => {
  ...
  describe("devLog", () => {
    ...
    it("should prefix messages with [rxblox]", () => {
      devLog("hello");

      expect(consoleLogSpy).toHaveBeenCalledWith("[rxblox] hello");
    });
  });
  ...
  describe("devWarn", () => {
    it("should warn in development", () => {
      ...
      expect(consoleWarnSpy).toHaveBeenCalledWith("[rxblox] warning message");
    });
  ...
  describe("devError", () => {
    it("should error in development", () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith("[rxblox] error message");
    });
  });
  ...
  describe("devAssert", () => {
    ...
    it("should throw when condition is false", () => {
      expect(() => devAssert(false, "test failure")).toThrow(
        "[rxblox] Assertion failed: test failure"
      );
    });
    ...
    it("should throw with custom message", () => {
      ...
      expect(() => devAssert(a === b, "math is broken")).toThrow(
        "[rxblox] Assertion failed: math is broken"
      );
    });
  });
});
